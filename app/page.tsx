  ...
  const handleValidateKey = async () => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        setError(data.error || t('invalidKeyError'))
      }
    } catch (err: any) {
      setKeyStatus('invalid')
      setError(t('checkKeyError'))
    } finally {
      setValidating(false)
    }
  }
          ...
          <div className="space-y-6">
            ...
            <Card>
              ...
              <CardContent className="space-y-4">
                ...
                <div>
                  <Label htmlFor="jobDescription">{t('jobDesc')}</Label>
                  <Textarea
                    id="jobDescription"
                    ...
                    {uploading ? (
                      ...
                      <div className="space-y-2">
                        ...
                        <p className="text-sm text-gray-600">
                          {!apiKey ? t('enterKeyFirst') : t('selectPDF')}
                        </p>
                      </div>
                    )}
                  </label>
          ...
          <div>
            {result ? (
              <div className="space-y-6">
                ...
                <Card>
                  <CardHeader>
                    <CardTitle>{t('matchScore')}</CardTitle>
                  </CardHeader>
                  <CardContent>
                ...
                <Card>
                  ...
                  <CardContent className="space-y-4">
                    <div>
                      <h4 className="font-semibold text-green-700 mb-2">{t('matchedSkills')}</h4>
                    ...
                    {result.skillsMatch.missing.length > 0 && (
                      <div>
                        <h4 className="font-semibold text-orange-700 mb-2">{t('missingSkills')}</h4>
                        <div className="flex flex-wrap gap-2">
                ...
                <Card>
                  <CardHeader>
                    <CardTitle className="text-green-700">{t('strengths')}</CardTitle>
                  </CardHeader>
                  <CardContent>
                ...
                <Card>
                  <CardHeader>
                    <CardTitle className="text-orange-700">{t('weaknesses')}</CardTitle>
                  </CardHeader>
                  <CardContent>
                    <ul className="space-y-2">
